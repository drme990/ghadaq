...
export const metadata: Metadata = {
  ...
  description:
    'مؤسسة غدق - نُؤدي عنك بالوكالة الشرعية: عمرة البدل، حج البدل، العقيقة، الأضاحي، النذر، الصدقة، حفر الآبار ووصلات المياه. التزام شرعي، جودة عالية، وتوثيق احترافي يطمئن القلب.',
  keywords: [
    'غدق',
    'مناسك',
    'عمرة البدل',
