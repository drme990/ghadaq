                                ...
                                <div key={idx}>
                                  ...
                                  {field.type === 'select' ? (
                                    <select
                                      ...
                                      dir={isRTL ? 'rtl' : 'ltr'}
                                      className="w-full px-4 py-3 rounded-site border border-stroke bg-card-bg text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all text-sm"
                                    >
                                      <option value="">—</option>
                                    ...
                                    <div className="space-y-2">
                                      <input
                                        ...
                                        className="w-full px-3 py-2 rounded-site border border-stroke bg-card-bg text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all text-sm"
                                      />
                                      {reservationData[idx] && (
                                        <img
                                    ...
                                    <input
                                      ...
                                      required={field.required}
                                      dir={isRTL ? 'rtl' : 'ltr'}
                                      className="w-full px-4 py-3 rounded-site border border-stroke bg-card-bg text-foreground placeholder:text-secondary/60 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all text-sm"
                                    />
                                  )}
