    ...
    async function loadAppearance() {
      try {
        const [projectRes, sharedRes] = await Promise.all([
          fetch('/api/appearance?project=ghadaq', { cache: 'no-store' }),
        ...
        const rawDocumentationAnswer =
          sharedData?.data?.documentationAnswer;
